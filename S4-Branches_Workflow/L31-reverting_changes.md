...
We can delete one or various commit with *git reset --hard <commit>*. This will delete all commits up to and including the referenced commit.
...
We use *git revert <commit>* - here you don't use the ^ in the HEAD.
