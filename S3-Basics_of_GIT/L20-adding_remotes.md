...
We need to add a remote before being able to use it: git remote add
`git remote add remote_name (origin) <repo url>` -> origin is the common name when only one repo exists
